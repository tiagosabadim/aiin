    ...
    <div style={{ minHeight:'100vh', background:'var(--bg)', display:'flex', alignItems:'center', justifyContent:'center', padding:24 }}>
      <div style={{ width:'100%', maxWidth:520 }}>
        ...
        <div style={{ textAlign:'center', marginBottom:32 }}>
          <div style={{ width:52, height:52, borderRadius:16, background:'var(--gradient)', display:'inline-flex', alignItems:'center', justifyContent:'center', marginBottom:14, fontSize:22, color:'white', boxShadow:'0 8px 24px rgba(247,37,133,.3)' }}>★</div>
          <div style={{ fontSize:24, fontWeight:700, color:'var(--text-1)', letterSpacing:'-.3px', marginBottom:6 }}>
            Configurar <span style={{ background:'var(--gradient)', WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent' }}>sua marca</span>
          </div>
          <div style={{ fontSize:14, color:'var(--text-3)' }}>Preencha uma vez. A IA aprende e cria com sua identidade.</div>
        </div>
        ...
        <div className="card" style={{ padding:'28px 32px' }}>
          ...
          {step === 2 && (
            <div style={{ display:'flex', flexDirection:'column', gap:14 }}>
              <div style={{ fontSize:16, fontWeight:600, color:'var(--text-1)', marginBottom:4 }}>Público e comunicação</div>
              <div>
              ...
              <div>
                ...
                <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:8 }}>
                  {TONES.map(t => (
                    <button key={t} onClick={() => setTone(t)} style={{ padding:'9px 10px', fontSize:12, cursor:'pointer', fontFamily:'var(--font-sans)', border:`1px solid ${tone===t ? 'rgba(247,37,133,.4)' : 'var(--border-md)'}`, borderRadius:'var(--radius-md)', textAlign:'left', background: tone===t ? 'var(--gradient-soft)' : 'transparent', color: tone===t ? 'var(--text-1)' : 'var(--text-3)', fontWeight: tone===t ? 500 : 400, transition:'all .15s' }}>{t}</button>
                  ))}
                </div>
              </div>
              <div>

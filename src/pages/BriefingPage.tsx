        ...
        <div>
          <div style={{display:'flex',alignItems:'center',gap:8,marginBottom:6}}>
            ...
            <h1 style={{fontSize:22,fontWeight:700,color:'#070D1F',letterSpacing:'-.4px'}}>
              {phase==='plan'?'Criar post avulso':`${items.length} posts planejados`}
            </h1>
          </div>
          <p style={{fontSize:13,color:'#6B7280',lineHeight:1.5}}>
            {phase==='plan'?'Crie posts individuais: feed, carrossel, stories ou capa de Reels.':`${items.filter(i=>i.status==='pending').length} pendentes · ${itemCr} créditos · ${credits} disponíveis`}
          </p>
        </div>
